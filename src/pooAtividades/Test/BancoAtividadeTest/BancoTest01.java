...
public class BancoTest01 {
	...
	public static void main(String[] args) {
		...
		int numeroDeContas = Integer
				.parseInt(JOptionPane.showInputDialog("Informe o total de contas que você possiu: "));
		...
		JOptionPane.showMessageDialog(null, mensagemContaBancaria, "Informações da conta",
		...
		if (respostaDepInicial.charAt(0) == 's' || respostaDepInicial.charAt(0) == 'S' || respostaDepInicial == "Sim"
			...
			int opcaoConta = Integer.parseInt(JOptionPane.showInputDialog(
		...
		int opcaoContaDep = Integer.parseInt(JOptionPane.showInputDialog(
		...
		int opcaoContaSaq = Integer.parseInt(JOptionPane
				.showInputDialog(mensagemContaBancaria + "\nInforme o número da conta na qual deseja fazer o saque"));
